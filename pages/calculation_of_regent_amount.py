...
regent = st.text_input("Please input regent")
st.write("as")
loaded_formation = st.text_input("loaded formation")
st.write("of")
loading_amount = float(st.text_input("Please enter the number"))
unit_of_amount = st.selectbox("", ("wt%", "mol%"))
st.write("on")
support = st.text_input("Please input support name as molecular formula")
